...
replace (
	...
	github.com/tikv/client-go/v2 => github.com/HuSharp/client-go/v2 v2.0.0-20230223122614-b4127d2e7c73
	github.com/tikv/pd/client => github.com/HuSharp/pd/client v0.0.0-20230223103859-0c6ceb2aacb6
