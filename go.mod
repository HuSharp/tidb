...
replace (
	...
	github.com/tikv/client-go/v2 => github.com/HuSharp/client-go/v2 v2.0.0-20230302060222-4968b10fcf24
	github.com/tikv/pd/client => github.com/HuSharp/pd/client v0.0.0-20230302055645-91923a0f0776
