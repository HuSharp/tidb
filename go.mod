...
replace (
	...
	github.com/tikv/client-go/v2 => github.com/HuSharp/client-go/v2 v2.0.0-20230302061606-d3de6383c59d
	github.com/tikv/pd/client => github.com/HuSharp/pd/client v0.0.0-20230302061307-d56342fd09e0
